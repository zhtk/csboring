...
CURSOR testquery (p1 NUMBER, p2 NUMBER, p3 NUMBER) IS
...
BEGIN
  ...
  par2 := dbms_random.value(0, 1000000);
  par3 := dbms_random.value(0, 1000000);

  tbl := dbms_utility.get_time;
  FOR Cnt IN 1..100000 LOOP
  OPEN testquery(par1, par2, par3);
  CLOSE testquery;
  END LOOP;
  ...
  INSERT INTO wyniki2a VALUES (tbl, ixb, ix1k, ix2k, ix3k, ixz);
END;
/
